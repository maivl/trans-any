      ...
      <main class="flex min-w-0 flex-1 flex-col">
        ...
        <div class="flex min-h-0 flex-1 flex-col">
          <ChatPane
            ...
            onSendText={room.handleSendText} onSendFile={room.handleSendFile} onDownload={room.handleDownload} onPin={room.handlePin} onSendSettings={room.handleSendSettings}
